...
import logo1 from '../assets/careem.jpg'
  ...
  return (
   ...
   <div className="background-gradient">
        <div className="w-full h-10 bg-black-200 rounded-md my-4 p-2">
          <h2 className="text-center text-[16px] sm:text-[30px] text-green-400">Blockchain-Powered Supply Chain</h2>
          <p className="text-center font-mono font-extrabold text-[12px] sm:text-[18px]" >Efficient, Transparent,Trackable and Secure</p>
        </div>
      </div>
      ...
      <div className="container mx-auto py-12 ">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 ">
          <div className="bg-white p-8 rounded shadow-md border-black border-2">
            ...
            <h3 className="text-sm sm:text-xl font-bold mb-2 text-center">Careem</h3>
            <p className="text-gray-700 font-thin sm:font-medium text-center">partnership details....</p>
          </div>
          <div className="bg-white p-8 rounded shadow-md border-black border-2">
