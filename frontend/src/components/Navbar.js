    ...
    <nav className="background-gradient2">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <a href="/tracking" className="text-white font-bold text-lg">
  <img src={logo} alt="Logo" className="h-10 w-10" />
          ...
          <div className={`hidden md:block ${isMobileMenuOpen ? 'block' : 'hidden'}`}>
            <div className="ml-4 md:ml-10 flex items-baseline space-x-4">
              ...
              <a href="/minting" className="text-gray-300 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Minting</a>
